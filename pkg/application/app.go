...
type Application struct {
	*qt.QApplication
	...
	queryFavoriteButton *qt.QPushButton
...
func (app *Application) Run() {
	...
	frequencyTable.SetHorizontalHeaderItem(
		0,
		qt.NewQTableWidgetItem2("Query"),
	)
	frequencyTable.SetHorizontalHeaderItem(
		1,
		qt.NewQTableWidgetItem2("Count"),
	)
